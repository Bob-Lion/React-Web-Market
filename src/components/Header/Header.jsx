    ...
    <div className="App_Header">
      ...
      <header className={classes.header}>
        ...
        {login ? 
          ...
          <li className={classes.header__top__customer_username} onMouseEnter={handleMouseOverUser} onMouseLeave={handleMouseOutUser} >
            <a href="#!">
              <span>일반</span> {user.name} 님 
              <img alt="새로운 유저 로고" className={classes.header__top__customer_username__logo} src={userNewLogo} />
              <img alt="삼각형 아이콘" src={triangleIcon} />
            </a>
            <ul className={classes.header__top__customer_username__popup} hidden={!hoverUser} >
              ...
              <li><a href="#!">나의 컬리 스타일 <img alt="New" className={classes.header__top__customer_username__logo} src={userNewLogo} /></a></li>
              <li><a href="#!">로그아웃</a></li>
            </ul>
          </li>
          <li className={classes.header__top__customer_service} onMouseEnter={handleMouseOver} onMouseLeave={handleMouseOut} >
            ...
            <ul className={classes.header__top__customer_service__popup}   hidden={!hover}  >
              <li><a href="#!">공지사항</a></li>
            ...
            <ul className={classes.kurly}>
              <li>
                <h1 className={classes.kurly__logo}>
                  <Link to={'/'}>
                    <img alt="kurly logo" className={classes.kurly__logo_icon} src={logo} />
                  </Link>
                </h1>
              </li>
              <li>
              ...
              <li>
                <a className={classes.kurly__beauty} href="#!">뷰티컬리</a>
                <img alt="new logo" className={classes.kurly__new_icon} src={newLogo} />
              </li>
            </ul>
